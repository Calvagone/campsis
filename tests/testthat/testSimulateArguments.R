...
test_that("Argument dest works well", {
  ...
  # Unknown engine
  expect_error(model %>% simulate(dataset=dataset, dest="ENGINE3"), regexp="Argument 'dest' must be one of: 'rxode2', 'mrgsolve' or NULL")

  # Default engine (rxode2)
...
test_that("Auto seed value vs fix seed + default engine", {
  ...
  # Check rxode2 was chosen as default engine
