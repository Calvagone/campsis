...
results_f1 <- model %>% simulate(dataset=ds1, dest="rxode2", seed=1)
results_no_f1 <- model_library$advan4_trans4 %>% simulate(dataset=ds1, dest="rxode2", seed=1)
...
results_f1 <- model_library$advan4_trans4 %>% simulate(dataset=ds2, dest="rxode2", seed=1)
