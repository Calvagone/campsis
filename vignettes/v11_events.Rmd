...
gridExtra::grid.arrange(spaguettiPlot(results, "CP"), spaguettiPlot(results, "BW"), ncol=1)
```
...
gridExtra::grid.arrange(spaguettiPlot(results, "CP"), spaguettiPlot(results, "DOSE"), ncol=1)
```
