...
scenarios <- Scenarios() %>% 
  add(Scenario("1000 mg SD", dataset=~.x %>% set_subjects(3) %>% add(Bolus(time=0, 1000)))) %>%
  add(Scenario("1500 mg SD", dataset=~.x %>% set_subjects(5) %>% add(Bolus(time=0, 1500)))) %>%
  add(Scenario("2000 mg SD", dataset=~.x %>% set_subjects(10) %>% add(Bolus(time=0, 2000))))
